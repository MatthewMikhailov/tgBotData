...
try:
    dm_data_df = pd.read_excel('market_samples/CONSUMER_GOODS_template.xlsx', index_col=False, sheet_name='Справочник', keep_default_na=False)
...
try:
    kp = pd.read_excel('market_samples/Копия вв КЭ.xlsx', index_col=False, sheet_name='Карточка товара', keep_default_na=False)
except FileNotFoundError:
    try:
        os.mkdir('market_samples')
    except FileExistsError:
